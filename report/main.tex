...
Foram elaborados 7 casos de uso da ferramenta, sendo os 2 primeiros elaborados pelo grupo e os outros 5 provenientes de entrevistas com 3 profissionais de saúde das áreas de Pediatria, Atendimento Intensivo e Clínica Geral:
...
\subsection{Caso de Uso 3: Estado Hiperosmolar Hiperglicêmico}
 
Um médico relata o caso de um paciente de 47 anos com estado
hiperosmolar hiperglicêmico e consulta o sistema durante o
atendimento para confirmar a conduta indicada. O assistente
recupera as páginas do Guia de Referência Rápida de Diabetes
Mellitus que tratam da condição e apresenta a conduta
recomendada, indicando a página de origem para verificação.
 
\subsection{Caso de Uso 4: Cetoacidose Diabética Sintomática}
 
Um médico questiona o sistema sobre o manejo de um quadro de
cetoacidose diabética sintomática, com dor abdominal e dor
periférica. O assistente recupera as páginas pertinentes do Guia
de Referência Rápida de Diabetes Mellitus e apresenta a conduta
recomendada, indicando a página de origem para verificação.
 
\subsection{Caso de Uso 5: Poliúria em Paciente com Diabetes Tipo 2}
 
Um médico consulta o sistema sobre a investigação de poliúria em
uma paciente de 63 anos com diabetes tipo 2. O assistente recupera
as páginas pertinentes do Guia de Referência Rápida de Diabetes
Mellitus e apresenta a conduta recomendada, indicando a página de
origem para verificação.
 
\subsection{Caso de Uso 6: Abortamento com Sangramento}
 
Um profissional consulta o sistema sobre o manejo de um processo
de abortamento com sangramento em uma gestante de 24 anos. O
assistente recupera os trechos pertinentes do Guia de Referência
Rápida de Pré-Natal, apresenta a conduta indicada e a página
correspondente, apoiando a decisão clínica sem que o profissional
precise localizar manualmente a seção do guia.
 
\subsection{Caso de Uso 7: Infecção Urinária em Gestante}
 
Um profissional consulta o sistema sobre a conduta diante de uma
infecção urinária em uma gestante de 31 anos. O assistente
recupera os trechos pertinentes do Guia de Referência Rápida de
Pré-Natal, apresenta a conduta indicada e a página correspondente,
apoiando a decisão clínica sem que o profissional precise
localizar manualmente a seção do guia.
